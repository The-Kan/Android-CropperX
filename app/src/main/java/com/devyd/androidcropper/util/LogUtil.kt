...
object LogUtil {
    ...
    fun logMemoryStats(context: Context? = null) {
        ...
        Log.i("Deok", "oom test Java heap → max=${maxHeap/1024/1024}MB, total=${totalHeap/1024/1024}MB, free=${freeHeap/1024/1024}MB, avail=${availHeap/1024/1024}MB")
        ...
        Log.i("Deok", "oom test Native heap → size=${nativeSize/1024/1024}MB, alloc=${nativeAlloc/1024/1024}MB, free=${nativeFree/1024/1024}MB")
        ...
        if(context != null) {
            ...
            Log.i("Deok", "oom test System Memory → avail=${memInfo.availMem/1024/1024}MB, lowMemory=${memInfo.lowMemory}, threshold=${memInfo.threshold/1024/1024}MB")
        }
